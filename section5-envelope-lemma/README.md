...
Independent, standalone audit of **Theorem 16** (the envelope estimate) and its inputs. Builds
...
certified bounds `|H'| < 0.007`, `|H''| < 0.04` (a coarser pair sufficient for this proof; see
`section3-periodic-correction/` for the sharp values); and a table showing `B0*(w*-w0)` and
